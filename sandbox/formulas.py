...
class VarLocations():
    ...
    def __init__(self, var_to_rows):
        self.var_to_rows = var_to_rows
        
    def get_row(self, varname):
        try:
            return self.var_to_rows[varname]
        except KeyError:
            print("Variable without row: " + varname)
...
class Segment():
    ...
    def __init__(self, text, var_to_rows):
        ...
        self.col = int(b)
        self.row = VarLocations(var_to_rows).get_row(varname)   
