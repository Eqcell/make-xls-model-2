...
from eqcell_core import TIME_INDEX_VARIABLES
...
def get_dataframe_before_equations(data_df, controls_df, var_list):    
    ...
    # Subsetting a union of 'data_df' and 'controls_df' with , protected for error.
    try:
        return df[var_list]
    except KeyError:
